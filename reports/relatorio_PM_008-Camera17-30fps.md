# Relatório automático de desvios posturais — PM_008-Camera17-30fps

**Exercício:** Agachamento (Ex6) — *rótulo do dataset, não detectado automaticamente*

## Gráfico

![ângulos posturais](figures/angulos_PM_008-Camera17-30fps.png)
...
- **Tempo de processamento:** OpenPose (extração) 2458 s (~41.0 min) · Análise 17.2 s · Total (extração + análise) 2476 s (~41.3 min)
